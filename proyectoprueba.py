...
while eleccion != 7:
	if eleccion == 1:
		...
		api1 = requests.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards",
		headers={
		...
		for datos in data1:
			if datos == eleccion:
				print(Fore.BLUE + Style.BRIGHT + "La carta con nombre ", datos["name"], " cuesta ", eleccion, " de maná")
				print(" ")
		...
		api5 = requests.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards",
		headers={
		"X-Mashape-Key": "FzegltnIocmsh3211BaWO5zC9HaDp1WHpBSjsn97fHvf0DGNG8"
		}
		)
		...
		api6 = requests.get("https://omgvamp-hearthstone-v1.p.mashape.com/cards/qualities/"+calidad,
		headers={
		"X-Mashape-Key": "FzegltnIocmsh3211BaWO5zC9HaDp1WHpBSjsn97fHvf0DGNG8"
		}
		)
		...
		print(Fore.RED + Style.BRIGHT +"Opción incorrecta, elige un numero del 1 al 7")
		print()
	eleccion=int(input("Elige un número: "))
print(" ")
